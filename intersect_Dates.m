...
%% buscamos coincidencias con ismember por cada variable fisica en la pesca
...
%%
% Initialize a structure to hold the variables
%guardamos las fechas de la interseccion de las variables ambientales y los
%28 puertos
% GambaMCS = struct();
% 
% % Loop through the cell array and assign each cell array to a field in the structure
...
%         fieldName = colAmb{i};
%         GambaMCS.(fieldName) = time_intersect_cum{i};
%     end
% end
...
for i = 1:numel(time_intersect_cum)
    ...
    if ~isempty(time_intersect_cum{i})
        ...
        GambaMCS2.(fieldName) = T_intersect;
    end
end

save('MCS_intersect.mat','GambaMCS2');
%% plot
